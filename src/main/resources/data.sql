...
INSERT INTO users (username, password, enabled) VALUES ('root', '$2a$10$2wRGhGuTsnVJ6juuKuKoOee.7OKdVfXwdqe/xI9JWbfHrk1mcw6PK', TRUE);
INSERT INTO users (username, password, enabled) VALUES ('jake', '$2a$10$2wRGhGuTsnVJ6juuKuKoOee.7OKdVfXwdqe/xI9JWbfHrk1mcw6PK', TRUE);
INSERT INTO users (username, password, enabled) VALUES ('christian', '$2a$10$2wRGhGuTsnVJ6juuKuKoOee.7OKdVfXwdqe/xI9JWbfHrk1mcw6PK', TRUE);

INSERT INTO Roles (name) VALUES ('ROLE_ROOT'),('ROLE_ADMIN'),('ROLE_USER'),('ROLE_VISITOR');

INSERT INTO authorities (username, role) VALUES ('root', 'ROLE_ROOT');
INSERT INTO authorities (username, role) VALUES ('christian', 'ROLE_ADMIN');
INSERT INTO authorities (username, role) VALUES ('jake', 'ROLE_VISITOR');
